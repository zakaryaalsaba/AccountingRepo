...
const navGroups = computed(() => [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/bank-treasury', label: t('nav.bankTreasury'), icon: 'wallet', needsCompany: true },
      { to: '/reports', label: t('nav.reports'), icon: 'chart', needsCompany: true },
      { to: '/fiscal-years', label: t('nav.fiscalYears'), icon: 'calendar', needsCompany: true },
      { to: '/analysis', label: t('nav.analysis'), icon: 'chart', needsCompany: true },
      { to: '/vouchers', label: t('nav.vouchers'), icon: 'doc', needsCompany: true },
      { to: '/cheques', label: t('nav.cheques'), icon: 'doc', needsCompany: true },
      ...
      { to: '/approvals', label: t('nav.approvals'), icon: 'clipboard', needsCompany: true },
    ],
  },
  {
